...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1503187200, 22697458, 0x1e0ffff0, 1, 50 * COIN);
        ...
        checkpointData = (CCheckpointData) {
            ...
            ( 50, uint256S("0x0000000000000bccdb11c2b1cfb0ecab452abf267d89b7f46eaf2d54ce6e652c")),
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1503187200, 3899711235, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0"));
        assert(genesis.hashMerkleRoot == uint256S("0x0"));
