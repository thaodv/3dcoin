...
public:
    CMainParams() {
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x000002d956af9d777e10db763e2d1228713f4a19cbe77cf024343fafc9581c1b"));
...
public:
    CTestNetParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0000047d0baba5a1c37a2cd04100a1bb250761121aea8787a279f631006409ad"));
        assert(genesis.hashMerkleRoot == uint256S("0x3af062a335e2ba457b0bcb38441a7a9782025fffe64222aa3d3f6e203e8b3f08"));
