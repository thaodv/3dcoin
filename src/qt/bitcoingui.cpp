    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("3DCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a 3DCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and 3DCoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About 3DCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about 3DCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for 3DCoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your 3DCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified 3DCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a 3DCoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the 3DCoin Core help message to get a list with possible 3DCoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("3DCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to 3DCoin network", "", count));
}
...
{
    QString strTitle = tr("3DCoin Core"); // default title
