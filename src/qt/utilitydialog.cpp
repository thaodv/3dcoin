    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("3DCoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About 3DCoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  3dcoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the 3DC in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 3DC, 0.1 3DC, 1 3DC and 10 3DC -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://3dcoin.io/\">https://3dcoin.io</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("3DCoin Core is shutting down...") + "<br /><br />" +
