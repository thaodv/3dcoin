...
QString BitcoinUnits::description(int unit)
{
    if(Params().NetworkIDString() == CBaseChainParams::MAIN)
    {
        switch(unit)
        {
            case DASH: return QString("3DC");
            case mDASH: return QString("Milli-3DC (1 / 1" THIN_SP_UTF8 "000)");
            case uDASH: return QString("Micro-3DC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
