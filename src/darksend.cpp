...
{
    if(fLiteMode) return; // ignore all 3DCoin related functionality
...
/*
    ...
    allow endless transaction that would bloat 3DCoin and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("3dcoin-privatesend");
