...
class TxnMallTest(BitcoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 12,500 3DCOIN:
        ...
        # First: use raw transaction API to send 12400 3DCOIN to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 500 3DCOIN coin each
        ...
        # Node0's balance should be starting balance, plus 5003DCOIN for another
        ...
        # Node0's total balance should be starting balance, plus 10003DCOIN for
